...
public class GlobalData implements IGlobals {
   ...
   // public boolean[] stall_caused_by = new boolean[32];
    ...
    public int l_memory_output;
    public boolean l_load_value_available = false;
    public boolean l_my_next_load = false;
    public String l_load_memory_register = null;
    public String l_maintain_register = null;
    public int l_maintain_value;
    
    public String l_maintain_register_WB =null;
    public int l_maintain_value_WB;
