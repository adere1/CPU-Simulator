...
public class GlobalData extends PropertiesContainer implements IGlobals {
    ...
    public static int [] register_alias_table = new int [32];
    //public static HashMap<Integer,String> map = new HashMap<>(); 
    public static String [] issuequeue = new String [256];
    
    public static InstructionBase [] issue_queue = new  InstructionBase[256];
    public static Latch [] latch = new Latch[256];
    static boolean IQ_full = false;
    public static int freesource = -1;
