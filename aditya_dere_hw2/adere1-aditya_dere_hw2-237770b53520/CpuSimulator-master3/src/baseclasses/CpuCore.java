...
public abstract class CpuCore<GlobalsType extends IGlobals> implements ICpuCore<GlobalsType> {
    ...
    public void advanceClock() {        
    	...
    	//System.out.println("val is" + stages);
        for (PipelineStageBase stage : stages) {
        	//System.out.println("Inside PipelineStageBase");
            stage.compute();
        }
        ...
        for (int i=stages.size()-1; i>=0; i--) {
        	//System.out.println("Inside propagateStall");
        ...
        for (PipelineStageBase stage : stages) {
        	//System.out.println("Inside advanceClock");
            stage.advanceClock();
        }        
